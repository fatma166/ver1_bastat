...
class FCMService
{
    ...
    public static function send_push_notif_to_topic($data, $topic, $type)
    {
        ...
        $url ="https://fcm.googleapis.com/v1/projects/bastaat-4fba4/messages:send";//"https://fcm.googleapis.com/fcm/send";
        $header = array(
    ...
    {
        $key =config('fcm.token');
        $url = "https://fcm.googleapis.com/v1/projects/bastaat-4fba4/messages:send";
        $header = array(
