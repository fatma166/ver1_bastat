...
use App\Models\Zone;
use App\Repositories\Admin\SingleRebo\NotificationRepository;
...
class NotificationController extends BaseController
{
    ...
    public function edit($id)
    {
       // $governorates = Governorate::orderBy('name_' . app()->getLocale())->get();
        ...
        $zones=Zone::get();
        return view($this->view . 'edit', compact('record','zones'));
    }
