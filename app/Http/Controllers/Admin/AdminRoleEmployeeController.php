...
class AdminRoleEmployeeController extends BaseController
{
    use UploadAttachTrait;
    protected $view;
    protected $repository;

    public function __construct(AdminRoleEmployeeRepository $repository)
    {
        parent::__construct($repository);
        $this->view = 'admin-views.admin_role.';

    }
    public function index(Request $request, $with = [], $withCount = [], $filter = '', $paginate = 10, $whereHas = [])
    {
       $roles= parent::index($request, [], ['admin'], '', 10, []);
