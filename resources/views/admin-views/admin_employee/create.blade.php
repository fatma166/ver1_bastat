                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="projectname" name="f_name"  value="{{old("f_name")}}" class="form-control" placeholder="ادخل هنا اسم المدير">
                                    @error("f_name")
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="selectcat" name="role_id" value="{{old("role_id")}}"  class="form-control" data-toggle="select2" data-width="100%">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="projectname" name="email"  value="{{old("email")}}" class="form-control" placeholder="ادخل البريد الإلكتروني">
                                    @error("email")
                                    <span class="text-danger">{{ $message }}</span>
                                    @endError
                                </div>
